<script setup>
import TestimonialCardWidget from '@/components/landing/TestimonialCardWidget.vue';
import { ref } from 'vue';
            ...
            <div class="grid grid-cols-1 lg:grid-cols-[26.5%_1fr_26.5%] items-start gap-4 mt-16 lg:pt-32 lg:-mt-16 max-w-3xl lg:max-w-none mx-auto">
                <div class="hidden lg:grid grid-cols-1 gap-4 order-2 lg:order-1">
                    <template v-for="(testimonial, index) of testimonial1" :key="index">
                        <TestimonialCardWidget :testimonial="testimonial" />
                    </template>
                </div>
                <div class="grid grid-cols-1 gap-4 order-1 lg:order-2">
                    <div class="relative">
                        <div class="absolute -top-px -left-px w-full h-full border-2 border-dashed rounded-2xl border-primary/15" />
