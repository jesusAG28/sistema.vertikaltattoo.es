            ...
            <div class="relative mt-28 max-w-[54.5rem] mx-auto">
                ...
                >
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <Textarea id="message" v-model="message" rows="6" class="w-full !rounded-2xl" />
                    </div>
                    <Button class="w-full" rounded>Submit</Button>
                </form>
            </div>
        </div>
        <CustomersLogoWidget class="my-24 py-16 landing-container mx-auto" />
    </section>
</template>
